...
public abstract class BaseClientTagDataProvider<T, R extends KeyResolver<T>> implements DataProvider {
    ...
    public BaseClientTagDataProvider(PackOutput packOutput, String modid, R keyResolver) {
        ...
        this.modid = modid;
        this.pathProvider = packOutput.createPathProvider(PackOutput.Target.RESOURCE_PACK, TrimmedReference.TAGS_DIRECTORY + '/' + Utils.namespacedPath(TrimmedClientApi.getInstance().getId(keyResolver)));
