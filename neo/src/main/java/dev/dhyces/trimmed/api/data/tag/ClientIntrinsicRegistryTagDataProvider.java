...
public abstract class ClientIntrinsicRegistryTagDataProvider<T> extends ClientRegistryTagDataProvider<T> {
    ...
    public ClientIntrinsicRegistryTagDataProvider(PackOutput packOutput, String modid, ResourceKey<? extends Registry<T>> registryKey, Function<T, @Nullable ResourceLocation> encoder, CompletableFuture<HolderLookup.Provider> lookupProviderFuture, ExistingFileHelper existingFileHelper) {
