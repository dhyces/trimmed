...
public class TestClientMapKeys {
    ...
    public static final MapKey<Biome, Integer> MANUAL_TEST_BIOME_MAP = MapKey.baseKeyOf(TestClientMapTypes.BIOME_TEST, TrimmedTest.id("checked_biome_map"));
    ...
    public static final MapKey<DamageType, Integer> DATAGEN_TEST_DAMAGE_TYPE_MAP = MapKey.baseKeyOf(TestClientMapTypes.DAMAGE_TYPE_TEST, TrimmedTest.id("datapacked_damage_type_map"));
