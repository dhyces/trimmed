        ...
        gatherer.addAtlas(new ResourceLocation("armor_trims"))
                .addSource(new PalettedPermutations(
                        ...
                        Util.make(new HashMap<>(), map -> {
                                    map.put("echo", new ResourceLocation(Trimmed.MODID, "trim/color_palettes/echo"));
                                    map.put("blaze", new ResourceLocation(Trimmed.MODID, "trim/color_palettes/blaze"));
                                    map.put("shell", new ResourceLocation(Trimmed.MODID, "trim/color_palettes/shell"));
                                    map.put("prismarine", new ResourceLocation(Trimmed.MODID, "trim/color_palettes/prismarine"));
                                    map.put("glow", new ResourceLocation(Trimmed.MODID, "trim/color_palettes/glow"));
                                }
                        )
                )).finish();
    }
